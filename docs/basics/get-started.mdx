...
<DocCardList items={[ 
    ...
    findSidebarItem('/docs/category/stake-1'),
    findSidebarItem('/docs/category/rewards'),
    findSidebarItem('/docs/category/manage-profile'),
    findSidebarItem('/docs/category/slashing-and-bailout'),
    findSidebarItem('/docs/category/governance'),
    ]} />
...
<DocCardList items={[ 
    ...
    findSidebarItem('/docs/category/become-a-contributor'),
    ]} />