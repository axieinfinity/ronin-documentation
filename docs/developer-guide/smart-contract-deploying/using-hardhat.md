...
Deployment of smart contracts is only available on testnet. For mainnet, please refer [builder program](https://axie.substack.com/p/axie-infinity-builders-program) for more information
