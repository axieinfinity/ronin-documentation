...
4. Optionally, switch the top and bottom tokens by clicking the arrow down sign (↓) between the tokens.
...
6. In the **Confirm Swap** pop-up, review the details of your swap:
    ...
    2. Detailed swap information:
        ...
        * **Minimum received:** the lowest amount of tokens you can receive based on slippage tolerance. This is the worst-case scenario. Anything less than this value results in a failed transaction.
        * **Slippage tolerance:** the highest percent of price movement of the transaction. Anything greater than this value results in a failed transaction.
