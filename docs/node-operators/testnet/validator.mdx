---
description: Set up a validator node on testnet
---
...
### Bridge operator
* [https://github.com/axieinfinity/bridge-v2/releases/tag/v0.2.3](https://github.com/axieinfinity/bridge-v2/releases/tag/v0.2.3)
* [ghcr.io/axieinfinity/bridge:v0.2.3-56f7328](https://github.com/axieinfinity/bridge-v2/pkgs/container/bridge/80601341?tag=v0.2.3-56f7328)
...
<Tabs groupId="node-setup">
  <TabItem value="together" label="Validator and bridge">
    ...
    RONIN_PARAMS=--http.api eth,net,web3,consortium --miner.gaslimit 100000000 --miner.gasreserve 3000000
