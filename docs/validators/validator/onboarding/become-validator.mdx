...
2. Familiarize yourself with the requirements and slashing penalties applied to validators. It's also highly recommended that you read the [white paper](./basics/ronin/platform/white-paper).
<img src={stepOne} width={1280} />

3. Set up your validator and bridge operator nodes following the [guide](./validators/technician/setup).
