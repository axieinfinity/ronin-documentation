...
import valOnboardingStepOne from './assets/onboarding-step-1.png'
import valOnboardingStepTwo from './assets/onboarding-step-2.png'
import valOnboardingStepThree from './assets/onboarding-step-3.png'
import valOnboardingStepFour from './assets/onboarding-step-4.png'
import valOnboardingStepFive from './assets/onboarding-step-5.png'
