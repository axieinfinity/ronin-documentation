...
via Validator Dashboard or via a script.

Following are some types of proposals that can be created on tne dashboard:
...
The example used here is a proposal for adding a new Governing Validator.

## Prerequisites
Make sure that the validator that you want to add has already [registered](../onboarding/become-validator.mdx) as a Validator Candidate.
