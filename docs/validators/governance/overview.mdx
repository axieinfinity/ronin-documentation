---
description: Overview of on-chain governance for validators.
...
A governor creates a new proposal
for other governors to vote on. If at least 70% of the
governors approve the proposal, the change is approved and executed.
