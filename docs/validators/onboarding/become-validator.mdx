...
Before registering as a Validator Candidate, make sure that you have at least 250,000 RON for the initial stake. To acquire RON, see [Buy RON](./../../basics/buy-ron.mdx).
...
6. Enter your fast finality vote key—see [Add finality vote key](./../manage/add-finality-vote-key.mdx) for details.
