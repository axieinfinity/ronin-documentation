...
3. Set up your validator and bridge operator nodes following [Run a validator node](./../../node-operators/validator-setup-t.md) and [Run a bridge operator node](./../../node-operators/bridge-setup-t.md), respectively.
<img src={stepTwo} width={1280} />

4. Fill in your [addresses](./../manage/profile.mdx) and specify your commission rate.
