...
* **Finality vote key.** This is the [cryptographic key](add-finality-vote-key.mdx) used to vote
...
[vote](./../governance/vote-on-proposal.mdx) on changes to the validator set.
