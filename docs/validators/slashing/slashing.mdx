...
the self-stake.
* Temporary or permanent ban from the network, or _jail_.

Slashed RON go to back to the reward pool.
...
If a validator misses more than 100 blocks a day, the validator doesn't earn
